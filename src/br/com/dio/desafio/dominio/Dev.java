...
public class Dev {
    ...
    private Set<Conteudo> conteudosConcluidos = new LinkedHashSet<>(); //Coloca na ordem de conclução

    public void inscreverBootcamp(Bootcamp bootcamp){
        this.conteudoInscritos.addAll(bootcamp.getConteudos());//Pega tudo do bootconteudo e add em incritos
        bootcamp.getDevsInscritos().add(this); //Add no bootcamp
    }
